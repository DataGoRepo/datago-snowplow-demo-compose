package com.snowplowanalytics.snowplowdemokotlin.tracking
...
object Tracking {
    ...
    fun setup(namespace: String, context: Context): TrackerController {
        ...
        return Snowplow.createTracker(
            context, // передать можно любой другой контекст
            namespace,
            networkConfig,
            trackerConfig,
            emitterConfig,
    ...
    fun updateGlobalContext(globalContextTag: String, context: GlobalContext) {
        ...
        Snowplow.defaultTracker?.globalContexts?.add(
            globalContextTag,
            context
        ) // Добавляем измененный контекст (context: GlobalContext) по тегу (globalContextTag: String)
